...
@ResponseBody
public List<Comment> getAllCommentsByUser(@PathVariable("uid") int uid) {
  try {
    List<Comment> comments = commentManager.getAllCommentsByUser(uid);
    return comments;
  } catch (Exception e) {
...
@ResponseBody
public List<Comment> getAllCommentsByPost(@PathVariable("pid") int pid) {
  try {
    List<Comment> comments = commentManager.getAllCommentsByPost(pid);
    return comments;
  } catch (Exception e) {
...
public void delete(@PathVariable("pid") String pid) {
  try {
    commentManager.deleteComment(Integer.parseInt(pid));
  } catch (Exception e) {
